...
(function (a) {
    ...
    o.prototype = {
        constructor: o, init: function () {
            ...
            if (c.el) {
                ...
                c.src = c.el.attr("data-mfp-img"), c.src || (c.src = c.el.attr("href"))
            }
            ...
            d.data && (c = a.extend(d.data, c)), y(f, [b, c, d]), a.each(c, function (a, c) {
                ...
                if (e.length > 1) {
                    ...
                    if (d.length > 0) {
                        var f = e[1];
                        f === "replaceWith" ? d[0] !== c[0] && d.replaceWith(c) : f === "img" ? d.is("img") ? d.attr("src", c) : d.replaceWith('<img img="' + c + '" class="' + d.attr("class") + '" />') : d.attr(e[1], c)
                    }
    ...
    a.magnificPopup.registerModule(P, {
        options: {
            markup: '<div class="mfp-iframe-scaler"><div class="mfp-close"></div><iframe class="mfp-iframe" img="//about:blank" frameborder="0" allowfullscreen></iframe></div>',
